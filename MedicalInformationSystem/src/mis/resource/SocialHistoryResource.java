...
@Path("/socialhistoryinfo")
public class SocialHistoryResource {

	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Response putSocialHistory(SocialHistory patientMedInfo) {
		// return Response.status(201).entity(result).build();
		//System.out.println(patient.getUsername());
		return putAndGetResponse(patientMedInfo);
	}

	private Response putAndGetResponse(SocialHistory patientMedInfo) {
		Response res;
		...
		// }
		if (SocialHistoryDao.instance.putSurgicalHistoryDetails(patientMedInfo) != 0) {
