...
public class Test {
  public static void main(String[] args) {
    ...
    System.out.println(service.path("rest").path("user").accept(MediaType.APPLICATION_XML).get(String.class));
  }

  private static URI getBaseURI() {
    return UriBuilder.fromUri("http://localhost:8080/MedicalInformationSystem").build();
  }
